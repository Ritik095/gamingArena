...
public class SlideGame1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slide_game1);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SlideGame1.this,SlideGame2.class));
                finish();
            }
        });
    ...
    public void alertdialog(){
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SlideGame1.this,SlideGamelv.class));
            }
        });
