...
public class SlideGame3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slide_game3);
        ...
        nextl2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SlideGame3.this,SlideGame3.class));
                finish();
            }
        });
    ...
    public void alertdialog(){
        ...
        quitl2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SlideGame3.this,SlideGamelv.class));
            }
        });
