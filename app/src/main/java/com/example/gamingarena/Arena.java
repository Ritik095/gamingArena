...
public class Arena extends AppCompatActivity {
    ...
    public void crosswords(View v){
        startActivity(new Intent(Arena.this,CrossWord.class));
    }
    public void tictactoe(View v){
        startActivity(new Intent(Arena.this,Tic_Tac_Toe.class));
    }
    public void quiz(View v){
        startActivity(new Intent(Arena.this,Quiz.class));
    }
